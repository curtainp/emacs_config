...
;; 常用的命令
(defhydra ada/hydra-common-menu ()
  "
						^常用^
...
"
  ...
  ("1" ada/plus-alpha nil :color red)
  ("2" ada/less-alpha nil :color red)
  ("q" nil "QUIT" :color blue))
